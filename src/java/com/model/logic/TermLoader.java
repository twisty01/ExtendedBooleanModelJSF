...
public class TermLoader implements Serializable {
    ...
    // for html
    private ArrayList<String> listTerms;
    ...
    private void initialize() {
        ...
        terms = new HashMap<>();
        int i = 0;
        for (ListIterator<String> it = documents.listIterator(); it.hasNext();) {
            final int idx = i++;
            String path = it.next();
        ...
        // 3. compute weight
        terms.forEach((String term, List<DocTermValue> documentList) -> {
